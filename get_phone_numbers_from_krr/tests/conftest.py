...
def set_env_variables(monkeypatch: MonkeyPatch):
    ...
    monkeypatch.setenv(name='PUBSUB_BATCH_TOPIC_ID', value='batch_uttrekk_job')
    monkeypatch.setenv(name='KRR_ENDPOINT', value='https://test.kontaktregisteret.no')
    monkeypatch.setenv(name='KRR_SCOPE', value='global/kontaktinformasjon.read')
    # monkeypatch.setenv(name='BUCKET_PATH', value='innbyggerkontakt-dev')
