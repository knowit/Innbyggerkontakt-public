...
def get_client_matrikkel_context(matrikkelenhet_client: Client):
    """Creates matrikkel context.

    Returns:
        ns0:MatrikkelContext: matrikkel context
    """
    matrikkel_context = matrikkelenhet_client.factory.create('ns0:MatrikkelContext')
    snap_version = matrikkelenhet_client.factory.create('ns0:Timestamp')
